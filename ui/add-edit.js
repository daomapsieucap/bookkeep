    ...
    document.getElementById('screen').innerHTML = `
      ...
      <form id="book-form" class="px-4 pb-8 space-y-5">
          ...
          <div class="flex gap-3 items-start">
            ...
            <div class="flex flex-col gap-2 pt-1">
              <button type="button" id="cover-camera-btn"
                class="flex items-center gap-2 text-sm font-medium text-amber-600 active:opacity-60">
        ...
        <button type="submit" id="submit-btn"
          class="w-full py-3 rounded-xl bg-amber-500 text-white font-semibold text-base active:opacity-80 flex items-center justify-center gap-2">
      ...
      return `
        <div>
          ...
          <div class="flex items-center gap-2 mt-2">
            ...
            <button type="button" id="toggle-unit-btn" class="text-xs text-amber-600 underline">Switch to pages</button>
          </div>
        </div>`;
    }
    ...
    return `
      <div>
        ...
        ${getCurrentFormat() !== 'paper' ? `
          <div class="flex items-center gap-2 mt-2">
            <button type="button" id="toggle-unit-btn" class="text-xs text-amber-600 underline">Switch to percent</button>
          </div>` : ''}
      </div>`;
  }
