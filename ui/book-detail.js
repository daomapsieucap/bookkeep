...
const BookDetailScreen = (() => {
  ...
  function renderLoading() {
    document.getElementById('screen').innerHTML = `
      <div class="flex items-center justify-center h-64">
        <div class="spinner" style="border-color:rgba(245,158,11,0.3);border-top-color:#f59e0b"></div>
      </div>`;
  }
  ...
  function render() {
    ...
    document.getElementById('screen').innerHTML = `
      ...
      <div class="flex items-center gap-2 px-4 pt-5 pb-2">
        ...
        <button id="edit-btn"
          class="text-sm text-amber-600 font-medium active:opacity-60 shrink-0">Edit</button>
      </div>
        ...
        <div class="w-24 shrink-0 rounded-lg overflow-hidden shadow-sm">
          <div id="cover-wrap">
            <div class="cover-placeholder w-full" style="min-height:9rem">
              <div class="spinner" style="border-color:rgba(245,158,11,0.3);border-top-color:#f59e0b;width:24px;height:24px"></div>
            </div>
          </div>
        </div>
      ...
      <div class="mx-4 mb-4">
        <div class="flex items-center justify-between mb-2">
          ...
          <button id="toggle-notes-edit" class="text-sm text-amber-600 font-medium active:opacity-60">
      ...
      <div class="mx-4 mb-6">
        ...
        <div class="flex gap-2 mb-3">
          <button id="hl-camera-btn"
            class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-dashed border-stone-200 text-stone-400 text-sm font-medium active:opacity-60">
          ...
          <button id="hl-gallery-btn"
            class="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border-2 border-dashed border-amber-300 text-amber-600 text-sm font-medium active:opacity-60">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    return `
      <div class="mx-4 mb-4 bg-white rounded-2xl shadow-sm p-4">
        <div class="flex items-center justify-between mb-3">
          ...
          <span id="pct-display" class="text-sm font-semibold text-amber-600">${pct}%</span>
        </div>
      ...
      return `
        <div class="mx-4 mb-4">
          <button id="start-reading-btn"
            class="w-full py-3 rounded-xl bg-amber-500 text-white font-semibold active:opacity-80">
            Start Reading
          </button>
        </div>`;
    }
      ...
      return `
        <div class="mx-4 mb-4">
          <button id="re-read-btn"
            class="w-full py-3 rounded-xl border border-amber-400 text-amber-600 font-semibold text-sm active:opacity-60">
            Re-read
          </button>
        </div>`;
    }
  ...
  function statusBadge(status) {
    const map = {
      'reading':      ['bg-amber-100 text-amber-700',  'Reading'],
      'want-to-read': ['bg-stone-100 text-stone-600',  'Want to Read'],
